...
var CharacterComponent = (function () {
    function CharacterComponent(apiService, page) {
    ...
    CharacterComponent.prototype.getCharacters = function () {
        var _this = this;
        return this.apiService.call('public/characters', { 'offset': 100 * this.page, 'limit': 22 }).subscribe(function (data) { return _this.characters = data.results; });
    };
